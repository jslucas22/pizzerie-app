...
const Order: React.FC<ScreenBaseProps<'Order'>> = ({ navigation }) => {
    ...
    return (
        <>
            <OrderHeader id={order?.Id ?? 0} onGoBack={openExitModal} onAdd={() => navigation.navigate('Products', {
                notToList: true
            })} />
            <S.Container>
                <S.Footer>
                    ...
                    <Spacer height={16} />
                    <Button value='Finalizar Pedido' onPress={() => navigation.navigate('FinishOrder')} />
                    <Spacer height={16} />
